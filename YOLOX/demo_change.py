...
sys.path.append(r'D:\\pycharm_project\\yolov5_flask-main')

IMAGE_EXT = [".jpg", ".jpeg", ".webp", ".bmp", ".png"]


def run_yolox(demo="image",
              experiment_name="./YOLOX_output",
              name="yolox-m",
              path="",
              camid=0,
              save_result=True,
              exp_file="YOLOX/yolox_voc_s.py",
              ckpt=sys.path[0]+"./best_yolox_20230227.pth",
              device="cpu",
              conf=0.3,
              nms=0.3,
              tsize=640,
...
def make_parser():
    ...
    parser.add_argument("-expn", "--experiment-name", type=str, default="./YOLOX_output")
    parser.add_argument("-n", "--name", type=str, default="yolox-m", help="model name")

    parser.add_argument(
        "--path", default="static/uploads/000006.jpg", help="path to images or video"
    )
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="YOLOX/yolox_voc_s.py",
        type=str,
        help="please input your experiment description file",
    )
    parser.add_argument("-c", "--ckpt", default="YOLOX/best_yolox_20230227.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="cpu",
        type=str,
...
def main(exp, demo="image",
         experiment_name="./YOLOX_output",
         path="",
         camid=0,
         save_result=True,
         ckpt="YOLOX/best_yolox_20230227.pth",
         device="cpu",
         conf=0.3,
         nms=0.3,
         tsize=640,
...
if __name__ == "__main__":
    ...
    run_yolox(path=r"D:\python\yolov5_flask-main\static\uploads\000322.jpg")